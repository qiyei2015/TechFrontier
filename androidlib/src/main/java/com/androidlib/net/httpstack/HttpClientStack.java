...
import com.androidlib.net.config.HttpClientConfig;
...
public class HttpClientStack implements HttpStack{
    ...
    public Response performRequest(Request<?> request) {
        ...
        try {
            ...
            // 添加连接参数
            setConnectionParam(httpRequest);
            // 添加header
     ...
     */
    private void setConnectionParam(HttpUriRequest httpUriRequest){
